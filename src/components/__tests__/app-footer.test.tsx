...
describe('AppFooter', () => {
  test('renders footer element with correct structure', () => {
    ...
    expect(footer).toHaveClass('flex', 'flex-col', 'items-center', 'justify-between', 'gap-4', 'min-h-[3rem]', 'md:h-20', 'py-2', 'md:flex-row')
  })
  ...
  test('mode toggle is hidden on mobile and visible on desktop', () => {
    ...
    const toggleContainer = screen.getByRole('button', { name: /toggle theme/i }).parentElement
